...
class PrivateMessage(models.Model):
    ...
    sender = models.ForeignKey(Profile, verbose_name=_('sender'), related_name='sent_messages', on_delete=models.CASCADE)
    target = models.ForeignKey(Profile, verbose_name=_('target'), related_name='received_messages', on_delete=models.CASCADE)
