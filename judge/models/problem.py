...
class Problem(models.Model):
    ...
    group = models.ForeignKey(ProblemGroup, verbose_name=_('problem group'), on_delete=models.CASCADE)
...
class ProblemTranslation(models.Model):
    problem = models.ForeignKey(Problem, verbose_name=_('problem'), related_name='translations', on_delete=models.CASCADE)
...
class ProblemClarification(models.Model):
    problem = models.ForeignKey(Problem, verbose_name=_('clarified problem'), on_delete=models.CASCADE)
...
class LanguageLimit(models.Model):
    problem = models.ForeignKey(Problem, verbose_name=_('problem'), related_name='language_limits', on_delete=models.CASCADE)
