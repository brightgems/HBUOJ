# Generated by Django 2.1 on 2018-08-20 03:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.CharField(db_index=True, max_length=30, validators=[django.core.validators.RegexValidator('^[pc]:[a-z0-9]+$|^b:\\d+$|^s:', 'Page code must be ^[pc]:[a-z0-9]+$|^b:\\d+$')], verbose_name='associated Page')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(help_text='Organization name shows in URL', max_length=6, unique=True, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9]+$', 'Identifier must contain letters and numbers only')], verbose_name='identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checker', models.CharField(blank=True, choices=[('standard', 'Standard'), ('floats', 'Floats'), ('floatsabs', 'Floats (absolute)'), ('floatsrel', 'Floats (relative)'), ('rstripped', 'Non-trailing spaces'), ('sorted', 'Unordered'), ('identical', 'Byte identical')], max_length=10, verbose_name='checker')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('language', models.CharField(choices=[('zh-hans', 'Simplified Chinese'), ('en', 'English')], max_length=7, verbose_name='language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='judge.Language', verbose_name='preferred language')),
                ...
                ('user', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user associated')),
            ],
            options={
